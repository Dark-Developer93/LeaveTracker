...
export const orgDepartments = [
  ...
  },
  {
    ...
    description: "Deals with human matters",
    users: [],
  },
  {
    label: "Operations",
...
export const orgTitles = [
  {
    ...
    description: "Organization overall decision maker and department leader",
    subordinates: [],
  },
  {
    label: "SDP Developer",
  ...
  {
    label: "SDP Coordinator",
    id: "a8384875-0977-4c42-a20b-50058299052d",
    description: "Develop Software",
    subordinates: [],
  },
  {
